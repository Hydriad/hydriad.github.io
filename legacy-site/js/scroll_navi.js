...
*/
//https://github.com/senthilraj/ScrollNaviJs
    ...
    $.fn.scroll_navi = function(options) {
        ...
        return this.each( function() {
            ...
            win.scroll(function() {
                ...
                if(wh<=topvalue)
                {
                    $(elem).css({"position":"fixed","top":"0px","background-color":"white" });
                }
                else{
                    $(elem).css({"position":"absolute","top":(wh/5)*4+"px","background-color":"transparent"});
                }
            });
